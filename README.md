...
**What you get:**
- Single ApostropheCMS instance on Kubernetes
...
flowchart LR
    ...
    LB --> B1["ApostropheCMS #1"]
    LB --> B2["ApostropheCMS #2"]
    LB --> B3["ApostropheCMS #N"]
    B1 --> R[("Redis\nSessions + Cache")]
    B2 --> R
    B3 --> R
...
**What you get:**
- Auto-scaling ApostropheCMS pods on Kubernetes behind a load balancer
